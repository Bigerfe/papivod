<%@ Page Language="C#" AutoEventWireup="true" Codebehind="default.aspx.cs" Inherits="Easo.Web.DBMS.HyStHdNews._default" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="标题">
                                <ItemTemplate>
                                    <a href="/news/<%#Eval("id") %>" target="_blank" title="点击链接，查看内容.">
                                        <%#Eval("title") %>
                                    </a>
                                </ItemTemplate>

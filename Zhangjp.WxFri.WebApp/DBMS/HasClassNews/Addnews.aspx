<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Addnews.aspx.cs" Inherits=" Easo.Web.DBMS.HyStHdNews.Addnews" %>
                ...
                <tr>
                    ...
                    <td colspan="1" style="height: 19px">
                        <asp:RadioButtonList ID="raifcommend" runat="server" RepeatDirection="Horizontal"
                            ...
                            <asp:ListItem Value="1">是</asp:ListItem>
                            <asp:ListItem Value="0">否</asp:ListItem>
                        </asp:RadioButtonList>&nbsp; 如果选择推荐的话，这条信息发布后会在首页栏目对于的位置。</td>
                </tr>
                <tr>

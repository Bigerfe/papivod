<%@ Page Language="C#" AutoEventWireup="true" Codebehind="default.aspx.cs" Inherits="Easo.Web.DBMS.Lxxx._default" %>
        ...
        <table class="tj">
            ...
            <tr>
                <td align="left" class=" " colspan="2" style="height: 30px">
                    ...
                    &nbsp;&nbsp; &nbsp;
                    <asp:Button ID="Button1" runat="server" Text="发布信息" OnClick="Button1_Click" /></td>
            </tr>
            <tr>
                <td align="left" class=" " colspan="2" style="height: 30px">
                    ×排序数字设置的是在前台列表显示的顺序！ 排序规则为升序！如 1 2 3 4....</td>
            </tr>
            <tr>
                <td align="center" class="gridrow" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="add_yxaddress" HeaderText="院校地址">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="add_lxguojia" HeaderText="留学国家">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="add_lxms" HeaderText="留学模式">
                                <ItemStyle Width="80px" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="修改">
                                <ItemTemplate>
                                    <a href="Addnews.aspx?action=update&nid=<%#Eval("id") %>&typeid=<%=typeid %>">修改</a>
                                </ItemTemplate>
                                <ItemStyle Width="60px" />
                            </asp:TemplateField>
                        </Columns>

<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Addnews.aspx.cs" Inherits=" Easo.Web.DBMS.Lxxx.Addnews" %>
            ...
            <table class="tj">
                <tr>
                    <th align="center" colspan="2" style="width: 15%">
                        留学学校<asp:Label ID="msgtitle" runat="server" Text=""></asp:Label></th>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="right" style="width: 15%">
                        院校地址：</td>
                    <td colspan="1" style="height: 19px">
                        <asp:TextBox ID="txtdizhi" runat="server" MaxLength="20"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right" style="width: 15%">
                        留学国家：</td>
                    <td colspan="1" style="height: 19px">
                        <asp:TextBox ID="txtlxgj" runat="server" MaxLength="20"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right" style="width: 15%">
                        留学模式：</td>
                    <td colspan="1" style="height: 19px">
                        <asp:TextBox ID="txtlxms" runat="server" MaxLength="20"></asp:TextBox></td>
                </tr>
                ...
                <tr>
                    <td align="right" style="width: 15%">
                        添加日期：</td>
                    <td colspan="1" style="height: 19px">
                        <input id="txtaddtime" onfocus="setday(this);" runat="server" maxlength="20" type="text" readonly="readonly" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsClass.aspx.cs" Inherits="Easo.Web.DBMS.MsNews.NewsClass" %>
                ...
                <td align="center" class="gridrow" colspan="2">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>                                 
                                <ItemTemplate>
                                   <a href="NewsClass.aspx?cid=<%#Eval("id") %>&action=delete" onclick="return confirm('确实删除所选择的数据吗? 其所包含的信息信息也会同时删除..');">删除</a>  <a href="NewsClass.aspx?action=update&cid=<%#Eval("id") %>">修改</a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>

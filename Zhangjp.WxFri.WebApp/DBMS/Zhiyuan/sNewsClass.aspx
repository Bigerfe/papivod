<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sNewsClass.aspx.cs" Inherits="Easo.Web.DBMS.MsNews.Zhiyuan" %>
      ...
      <table class="tj">
            <tr>
                <th align="center" colspan="2" style="width: 15%">
                    <asp:Label ID="lname" runat="server"></asp:Label> 类别管理</th>
            </tr>
            <tr>
